...
function Header() {
  ...
  return (
    <header className=" sticky top-0 z-50 shadow-md flex items-center px-4 py-2 bg-white ">
      <Button
        color="gray"
        buttonType="outline"
        rounded={true}
      ...
      <div
        className="flex items-center mx-5 md:mx-20 flex-grow px-5 py-2 bg-gray-100 text-gray-600 rounded-lg
      ...
      <img
        loading="lazy"
        onClick={signOut}
        className=" inline-flex cursor-pointer h-12 w-12 rounded-full ml-2"
